...
export function applyOverride(modelInfo) {
  ...
  if (ov.theme !== undefined) {
    ...
    result.themeLabel =
      ov.themeLabel ||
      ov.theme.replace(/[+_%-]/g, " ").replace(/\b\w/g, (c) => c.toUpperCase());
  }
...
export function buildOverrideFromUI(uiState) {
  ...
  const sizeX =
    uiState.sizeX != null && uiState.sizeX !== ""
      ? parseFloat(uiState.sizeX)
      : null;
  const sizeY =
    uiState.sizeY != null && uiState.sizeY !== ""
      ? parseFloat(uiState.sizeY)
      : null;
  ...
  const customWidth =
    uiState.customWidth != null && uiState.customWidth !== ""
      ? parseFloat(uiState.customWidth)
      : null;
  const customDepth =
    uiState.customDepth != null && uiState.customDepth !== ""
      ? parseFloat(uiState.customDepth)
      : null;
  if (
    customWidth != null &&
    !isNaN(customWidth) &&
